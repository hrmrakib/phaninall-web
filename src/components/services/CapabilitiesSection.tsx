...
export default function CapabilitiesSection() {
  const [capabilities, setCapabilities] = useState<Capability[]>([
    ...
    },
    {
      ...
      description:
        "At Orange Tech Consultants, our Cloud & Data Engineering services empower businesses to scale and leverage their data effectively. We design and implement cloud infrastructures that are secure, scalable, and optimized for performance, ensuring seamless data storage, management, and access. <br /> <br /> Our data engineering expertise enables us to build robust data pipelines, transforming raw data into actionable insights through real-time analytics and efficient data integration. We also specialize in cloud migrations, ensuring smooth transitions to cloud platforms with minimal disruption. By combining cloud technologies and data engineering best practices, we help businesses unlock the full potential of their data while optimizing costs and performance.",
  ...
  return (
    <section className='max-w-5xl mx-auto pb-20'>
      <h2 className='text-2xl md:text-[40px] font-medium mb-8 md:mb-12 p-4  text-center'>
        <span className='text-[#080808d7]'>
          <span className='text-[#FF6B00]'>Our</span> Services
        </span>
