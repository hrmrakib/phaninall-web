  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
      {cards.map((card) => (
        <div
          key={card.id}
          className='relative bg-gradient-to-br from-[#ffffff] via-[#ffffff] to-[#ff6c0a57] border border-[#ff6c0a44] rounded-2xl px-4 py-7 shadow-sm transition-transform'
        >
          {/* Card Header */}
          <div
            className={`rounded-xl m-4 p-6 cursor-pointer transition-all duration-200 hover:shadow-md 
              ${
                card.isExpanded
          ...
          {card.isExpanded && (
            <div className='absolute left-0 right-0 top-full z-10 mt-[-10px] pt-[10px]'>
